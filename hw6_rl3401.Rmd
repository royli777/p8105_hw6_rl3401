...
```{r}
birthweight_df$babysex <- as.factor(birthweight$babysex)
birthweight_df$frace <- as.factor(birthweight$frace)
birthweight_df$mrace <- as.factor(birthweight$mrace)
birthweight_df$malform <- as.factor(birthweight$malform)
```
